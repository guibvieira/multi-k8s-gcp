...
kubectl set image deployments/client-deployment client=guibvieira/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=guibvieira/multi-worker:$SHA
